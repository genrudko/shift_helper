...
Public Function SH_ExtractEmbeddedReportTemplate() As String
    ...
    targetPath = tempRoot & Application.PathSeparator & "report_template.xlsx"
    ...
    Do While Dir$(targetPath) = vbNullString
        DoEvents
        If Timer - started > 20 Then Err.Raise vbObjectError + 572, , "Embedded report template extraction timed out."
    Loop
    On Error Resume Next
    Kill zipCopy
    On Error GoTo 0
